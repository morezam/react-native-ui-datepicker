...
declare const _default: React.MemoExoticComponent<({ day, onSelectDate, containerHeight, weekdaysHeight, styles, classNames, components, fontFamily, }: Props) => JSX.Element>;
