    ...
    if (onChange) {
      if (mode === 'single') {
        ...
        if (allowRangeReset && start && end) {
          onChange({
            startDate: (0, _dayjs.default)(selected).toDate(),
            endDate: undefined
          });
          return;
        }
        ...
        if (isReset) {
          ...
          onChange({
            startDate: isStart ? (0, _dayjs.default)(selected).toDate() : start ? (0, _dayjs.default)(start).toDate() : start,
            endDate: !isStart ? (0, _dayjs.default)((0, _utils.getEndOfDay)(selected)).toDate() : end ? (0, _dayjs.default)((0, _utils.getEndOfDay)(end)).toDate() : end
          });
        }
      } else if (mode === 'multiple') {
