...
export const isValidJalaliLocale = locale => VALID_JALALI_LOCALES.has(locale);
export const getJalaliMonths = locale => JALALI_MONTHS[locale] || JALALI_MONTHS.en;
 ...
 * @returns weekdays
 */
export const getWeekdays = (locale, firstDayOfWeek) => {
  dayjs.locale(locale);
 ...
 */
export function isMonthDisabled(month, date, {
  minDate,
  maxDate
}) {
